import type { ModeType } from "@daisycode/shared";
...
export function buildSystemPrompt({ mode }: SystemPromptParams): string {
  ...
  parts.push(`You are DaisyCode, an expert software engineer working as a coding assistant inside a terminal application.
